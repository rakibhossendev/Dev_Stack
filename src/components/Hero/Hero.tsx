        ...
        <section className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row  justify-between items-center">
                ...
                <div>
                    ...
                    <div className="mt-3">
                        <button className="p-4 cursor-pointer rounded text-white bg-gradient-to-r from-[#FF5722] to-[#7C3AED] ">Explore Technologies</button>
                        <button className="px-10 cursor-pointer p-2 rounded border-2 border-[#E5E7EB] text-[#374151] mx-3 hover:bg-[#fafafa]">Learn More</button>
                    </div>
                </div>
